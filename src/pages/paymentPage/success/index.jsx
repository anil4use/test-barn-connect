...
import SuccessImg from '../../../assets/images/SuccessfulImg.svg'
const index = () => {
    return (
        <Box h={{ base: "80vh", md: "90vh" }} display={'flex'} flexDir={'column'} justifyContent={'center'} alignItems={'center'} p="40px 0" bg="#fff" fontFamily="'Arvo', serif">
            <Flex h={{ base: "200px", lg: "400px" }} justifyContent="center">
                ...
                /> */}
                <Img src={SuccessImg} alt="Success" minH={'250px'} minW={'250px'} />
            </Flex>
            <Box textAlign="center">
                <Text fontSize={{ base: "40px", md: "80px" }} fontWeight={'bold'} fontStyle={'italic'}>Success!</Text>
                <Text fontSize={{ base: "20px", md: "30px" }} mt="10px">Your Payment was successful.</Text>
                <Link to={'/'}>
